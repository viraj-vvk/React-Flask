...
const UpdateField = ({ updateField, onUpdate }) => {
    ...
    // const [date, setDate] = useState(updateField.date)
    ...
    const onSubmit = (e) => {
        ...
        // console.log({ project, type_, link, website, bid, lead, man_days, result, date })
        setProject('')
        setType('')
        setLink('')
        setWebsite('')
    ...
    return (
        <div class="modal" id={`modal${updateField.id}`}>
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Update Fields</h5>
                    ...
                    <div class="modal-body">
                        <form onSubmit={(e) => e.preventDefault()}>
                            ...
                            <input type="submit" value="Update Field" data-dismiss="modal" className="btn btn-success" onClick={onSubmit} />
                        </form>
                    </div>
                </div>
            </div>
